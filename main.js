...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _getters__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getters */ \"./src/getters.js\");\n/* harmony import */ var _renderers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./renderers */ \"./src/renderers.js\");\n/* harmony import */ var _pageStyler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./pageStyler */ \"./src/pageStyler.js\");\n/* harmony import */ var _clearers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./clearers */ \"./src/clearers.js\");\n\n\n\n\n\n\n\n/*\n    submitInput calls the Weather API with the user's input as the argument.\n    getWeather is only called if a value has been entered by the user.\n*/\nasync function submitInput(location){\n    if(location != \"\"){\n        const data = await (0,_getters__WEBPACK_IMPORTED_MODULE_1__.getWeather)(location); \n        return data;\n    } else{\n        alert(\"A location must be entered first!\")\n        throw new Error(\"A location must be entered first!\")\n    }\n}\n\n\n/**\n * pageAction is the main function for the page when the search button \n * is pressed\n */\nasync function pageAction(){\n    let location = (0,_getters__WEBPACK_IMPORTED_MODULE_1__.getUserInput)();\n    await submitInput(location)\n    .then((dataObject) => {\n        (0,_clearers__WEBPACK_IMPORTED_MODULE_4__.clearPageData)();\n        (0,_clearers__WEBPACK_IMPORTED_MODULE_4__.clearHourlyDataList)();\n        (0,_renderers__WEBPACK_IMPORTED_MODULE_2__.renderPage)();\n        (0,_pageStyler__WEBPACK_IMPORTED_MODULE_3__.changePageStyle)(dataObject);\n        (0,_renderers__WEBPACK_IMPORTED_MODULE_2__.fillPageData)(dataObject);\n        const hourlyDataList = (0,_getters__WEBPACK_IMPORTED_MODULE_1__.getHourlyDataList)(dataObject);\n        (0,_renderers__WEBPACK_IMPORTED_MODULE_2__.renderFirstHourlyDataList)(hourlyDataList);\n        return dataObject;\n    })\n    \n    .catch((rejected) => {\n        console.log(rejected);\n    })\n}\n\n/**\n * Event listener to initialise the main event of the page\n */\nconst inputForm = document.querySelector(`#inputForm`);\ninputForm.addEventListener('submit', (e) => {\n    e.preventDefault();\n    pageAction();\n});\n\n//# sourceURL=webpack://tempchecks/./src/index.js?");
